...
Examples:
    search cisco                Search for Cisco modules
    search type=exploits        Search for all exploits
    use exploits/routers/dlink/dir_815_850l_rce  Select a specific exploit module"""
...
Examples:
    show options                Show the settings you need to configure
    set target 192.168.1.1      Set the target IP address
    check                       Check if the target is vulnerable before exploiting
    run                         Execute the exploit against the target"""
